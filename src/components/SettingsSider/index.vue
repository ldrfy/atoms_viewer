<template>
    <a-drawer v-model:open="openModel" class="settings-drawer" :placement="drawerPlacement" :mask="true"
        ...
        <div class="settings-body">
            <!-- 关键：activeKey 由父组件控制 -->
            <a-collapse v-model:activeKey="activeKeyModel" ghost accordion class="settings-collapse">
                ...
                <a-collapse-panel key="lammps" :header="t('settings.panel.lammps.header')">
                    <a-form layout="vertical">
                        ...
                        <a-space :size="6" style="margin-top: 8px; flex-wrap: wrap;">
                            ...
                            <a-tooltip v-if="activeLayerInfo"
...
const mobileHeight = ref<number>(loadNum("settingsDrawer.mobileHeight", Math.min(560, Math.floor(window.innerHeight * 0.75))));
