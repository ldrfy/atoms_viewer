<template>
    <div v-if="isSelecting" class="record-select-overlay" @pointerdown.prevent="ctx.onRecordOverlayDown"
        @pointermove.prevent="ctx.onRecordOverlayMove" @pointerup.prevent="ctx.onRecordOverlayUp"
